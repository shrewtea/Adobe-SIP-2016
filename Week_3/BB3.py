...
xlocation = int(SCREEN_WIDTH/2)
ylocation = int(SCREEN_HEIGHT/2)
...
while not done:
    ...
    # Ball 2 
    pygame.draw.circle(screen, ball_color, [xlocation, ylocation], ball_size)


    if xlocation >= SCREEN_WIDTH - ball_size or xlocation < ball_size:
        xspeed = xspeed * -1

    if ylocation >= SCREEN_HEIGHT - ball_size or ylocation < ball_size:
        yspeed = yspeed * -1
